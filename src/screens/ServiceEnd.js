      ...
      <View style={[globalStyles.container]}>
        ...
        <View style={{ marginTop: 12 }}>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <CustomText style={[globalStyles.ml2]}>{service.label}</CustomText>
            </View>
          ))}
        ...
        >
          ...
          >
            ...
            <CustomText style={{ color: "white", fontSize: 18, fontWeight: "bold" }}>
        ...
        <View style={{ alignItems: "center", marginVertical: 20 }}>
          <Image source={buddy} resizeMode="contain" style={{ width: 200, height: 200 }} />
        </View>
        ...
        >
          ...
          <CustomText style={{ color: "white", fontSize: 20, fontWeight: "bold" }}>
        ...
        {extendedTime > 0 && (
          <View>
            <CustomText
              style={[globalStyles.f28Medium, globalStyles.neutral500, globalStyles.mt2]}
            >
              Hey{" "}
            ...
            <CustomText
              style={[globalStyles.f12Regular, globalStyles.neutral500, globalStyles.mt2]}
            >
            ...
            >
              ...
              <View style={globalStyles.mt3}>
                <CustomText style={[globalStyles.font16, globalStyles.fontWeight600]}>
                  Others
                </CustomText>
                <TextInput
                  style={[globalStyles.textArea, globalStyles.mt3]}
        ...
        <TouchableOpacity onPress={CollectPayment} style={globalStyles.blackButton}>
